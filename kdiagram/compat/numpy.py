...
if hasattr(np, "find_common_type") and not IS_NP125_PLUS:  
    ...
    def find_common_type(array_dtypes=None, scalar_dtypes=None):
        return np.find_common_type(_to_dtype_list(array_dtypes),
                                   _to_dtype_list(scalar_dtypes))
...
# === Public API ===
__all__ = [
    "IS_NP2", "IS_NP125_PLUS",
    "int_", "float_", "bool_", "object_", "complex_", "str_",
    "NP_INT", "NP_FLOAT", "NP_BOOL", "NP_COMPLEX", "NP_STR",
