...
def _try_parse_and_run(variants: Iterable[list[str]]) -> None:
    """
    Try argv variants in order. If one parses and runs,
    we're done. If all fail, raise the last error.
    """
    ...
    for argv in variants:
        ...
        try:
            ...
            # Some repos wire slightly different flags.
            # If parse fails by SystemExit, try next.
