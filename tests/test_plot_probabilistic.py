...
# --- Fixture for generating probabilistic forecast data ---
...
def probabilistic_data():
    ...
    quantiles = np.linspace(0.05, 0.95, 19) # 90% interval covered by 19 quantiles
...
def test_plot_pit_histogram_raises_error_on_shape_mismatch(probabilistic_data):
